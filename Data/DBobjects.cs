...
namespace DatingSite.Data
{
    public class DBobjects
    {
        ...
        static List<InterestedUser> interestedUsers = new List<InterestedUser>()
        {
            new InterestedUser()
            {
                Id = Guid.NewGuid(),
        ...
        static List<Interested> interesteds = new List<Interested>()
        {
            ...
            new Interested()
            {
                Id = Guid.NewGuid(),
                UserId = users[10].Id,
                Users = new List<InterestedUser>() { interestedUsers![0] },
            },
        };
        ...
        public static void Initial(ApplicationDBContext context)
        {
            ...
            if(!context.InterestedUsers.Any())
            {
                context.InterestedUsers.AddRange(interestedUsers);
            }

            if(!context.Interesteds.Any())
            {
                context.Interesteds.AddRange(interesteds);
            }
