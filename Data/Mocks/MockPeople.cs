...
namespace DatingSite.Data.Mocks
{
    static public class MockPeople
    {
        ...
        }; // тут надо будет хранить пользовательские данные, когда мы заходим

        static List<Anket> ankets = new List<Anket>(){
            new Anket()
            {
                Id = Guid.NewGuid(),
                BlankId = blanks[0].Id
        ...
        static public List<Anket> Ankets { get { return ankets; } set { ankets.AddRange(value); } }
    }
}